...
package GUI.Quejas_Especialista;

import ConectorBD.ConexionBD;
import Controlador.Quejas_Especialista.ControladorQuejasEspecialista;
...
public class UiQuejasEspecialista {
    ...
    ControladorQuejasEspecialista controladorQuejasEspecialista;
    ...
    public UiQuejasEspecialista() {

        controladorQuejasEspecialista = new ControladorQuejasEspecialista();
    ...
    void hacerConsulta(ActionEvent evt) {
        ...
        ArrayList <String[]> solicitudesPorEspecialidad = controladorQuejasEspecialista.getQuejas(calificacion, departamento, ciudad, anioInicio, mesInicio, mesFin, anioFin, criterioConsulta);
        ...
        if (solicitudesPorEspecialidad.isEmpty()) {            
            ...
            try{ 
                ...
                for (int i = 0; i <= solicitudesPorEspecialidad.size() - 1; i++) {
                    especialistas.add(solicitudesPorEspecialidad.get(i)[0]);
                    quejas.add(Integer.parseInt(solicitudesPorEspecialidad.get(i)[1]));
                }

                if (!solicitudesPorEspecialidad.isEmpty()) {                    
                    PieChart = new FXPieChart(tituloGraficos, especialistas, quejas);
                    BarChart = new FXBarChart(tituloGraficos, "Especialistas", especialistas, "Solicitudes", quejas, "Solicitudes Hechas");
                    LineChart = new FXLineChart(tituloGraficos, "Especialistas", especialistas, "Solicitudes", quejas, "Solicitudes Hechas");
                } else {
