    ...
    void hacerConsulta(ActionEvent evt) {
        ...
        if (citasPorEspecialidad.isEmpty()) {            
            ...
            try{ 
                ...
                if (!citasPorEspecialidad.isEmpty()) {                    
                    PieChart = new FXPieChart("Top Examenes", especialidades, citas);
                    BarChart = new FXBarChart("Top Examenes", "Examenes", especialidades, "Citas", citas, "Citas Realizadas");
                    LineChart = new FXLineChart("Top Examenes", "Examenes", especialidades, "Citas", citas, "Citas Realizadas");
                } else {
