...
import Diagrama.ControladorCitasExamen;
import Diagrama.ControladorCitasTipoServicio;
...
public class UiCitasTipoServicio {
    ...
    JLabel labelCiudad, labelGenero, labelEstrato, labelEdad, labelIngresos, labelAnioInicio, labelAnioFin, labelCriterioConsulta, labelMesInicio, labelMesFin;
    ...
    void hacerConsulta(ActionEvent evt) {
        ...
        if (citasPorEspecialidad.isEmpty()) {            
            ...
            try{ 
                ...
                if (!citasPorEspecialidad.isEmpty()) {                    
                    PieChart = new FXPieChart("Top Servicios Solicitados", especialidades, citas);
                    BarChart = new FXBarChart("Top Servicios Solicitados", "Servicios Solicitados", especialidades, "Citas", citas, "Citas Realizadas");
                    LineChart = new FXLineChart("Top Servicios Solicitados", "Servicios Solicitados", especialidades, "Citas", citas, "Citas Realizadas");
                } else {
    ...
    protected void inicializarCriteriosDeConsulta(JComboBox criteriosDeConsulta){
        ...
        criterios[0][0] = "Examenes Más Solicitados";
        criterios[1][0] = "Examenes Menos Solicitados";
    ...
    protected void inicializarIngresos(JComboBox ingresosVentas){
        ...
        ingresos[1] = "Menor a $1.000.000";
        ingresos[2] = "De $1.000.001 a $2.000.000";
        ingresos[3] = "De $2.000.001 a $4.000.000";
        ingresos[4] = "De $4.000.001 a $5.000.000";
        ingresos[5] = "Mayor a $5.000.000";
