...
)
{
	...
	while(!feof($handle1))
	{
		...
		$linea_a_escribir = "$id_especialista,$nombre_tabla,$sede_especialista,$zona_especialista";

		if ($id_especialista == "" || $nombre_especialista  == "" || $sede_especialista  == "" || $zona_especialista  == "") {
